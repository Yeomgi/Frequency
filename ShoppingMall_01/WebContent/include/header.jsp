	...
	<div id="wrap"> <!--header.jsp "wrap" 시작하는 부분 -->
		<header>
			<div id="logo">
				...
				<img alt="TheFlasic" src="http://localhost:8092/ShoppingMall_01/imges/LOGO.png" width="250px">
				</a>
			<!--로고 끝-->
			...
			<a href="#">
			<img alt="Disigner" src="http://localhost:8092/ShoppingMall_01//imges/Disign2.png" width="150px" style="float: right;">
			</a>
			<!--개인디자이너 로고 끝  -->					
			</div>
